...
// Funciones que detectan cuando se clickea la pantalla y realizan las instrucciones dentro de la funcion
fondo1.addEventListener('click', function() {
    // Agrega fondo desertico
...
fondo2.addEventListener('click', function() {
    // Agrega fondo infernal
    canva.style.background = 'linear-gradient(90deg, rgb(199, 0, 0) 10%, rgb(255, 179, 2) 40%, rgb(255, 255, 255) 100%)';
});
fondo3.addEventListener('click', function() {
    // Agrega fondo de dia o en la playa
...
function cargaImagenes (){
    ...
    imgRex.src = '../assets/rex_principal.png'
